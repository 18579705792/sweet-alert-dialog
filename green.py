...
def modify():
    file = open('F:\AndroidStidioProjects\sweet-alert-dialog\zero.md', 'r')
    flag = int(file.readline()) == 0
    file.close()
    file = open('F:\AndroidStidioProjects\sweet-alert-dialog\zero.md', 'w+')
    if flag:
        file.write('1')
    else:
        file.write('0')
...
if __name__ == '__main__':
    daily_commit(datetime.date(2016, 4, 13), datetime.date(2018, 5, 25))
